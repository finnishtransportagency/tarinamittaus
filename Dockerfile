...
RUN mkdir ${CATALINA_HOME}/webapps/tarina

COPY --from=BUILD_BACKEND /data/target/TarinamittausUI.war ${CATALINA_HOME}/webapps/tarinamittaus.war
RUN unzip ${CATALINA_HOME}/webapps/tarinamittaus.war -d ${CATALINA_HOME}/webapps/tarinamittaus
